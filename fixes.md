...
+ [Data retention, deletion, and destruction in Microsoft 365](https://docs.microsoft.com/en-us/compliance/assurance/assurance-data-retention-deletion-and-destruction-overview)
+ [Teams deployment clean up](https://docs.microsoft.com/en-us/microsoftteams/scripts/powershell-script-deployment-cleanup)
+ [Bulk install Teams MSI](https://docs.microsoft.com/en-us/microsoftteams/msi-deployment)
...
+ [Restoring Domain Controller from an Application-Aware backup](https://www.veeam.com/kb2119)
+ [SQL LDF not smaller after truncation](https://www.veeam.com/kb1876)
+ ["Invalid Credentials" error adding a Hyper-V host using a local account](https://www.veeam.com/kb1914)
+ [Adding Server 2019/Hyper-V 2019 to Veeam Fails](https://www.veeam.com/kb2909)
+ [Mounted Backups Timeout](https://forums.veeam.com/veeam-backup-replication-f2/mounted-backup-and-timeouts-t27355.html)
+ ["Access is Denied." when using a local account to add Windows machine](https://www.veeam.com/kb4185)
